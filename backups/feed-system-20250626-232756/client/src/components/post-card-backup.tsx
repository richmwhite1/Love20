        ...
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent p-4">
          <div className="flex items-center justify-between text-white">
            <div className="flex items-center space-x-4 text-sm">
              ...
              <FeedShareButton postId={post.id} />
            ...
            <div className="flex items-center space-x-2">
              ...
              <PostActionsMenu postId={post.id} post={post} />
            </div>
          </div>
        </div>
      </ViewTracker>
      ...
      <div className="p-6">
        ...
        {(post.spotifyUrl || post.youtubeUrl) && (
          <div className="mb-6">
            <InlineMediaPlayer
              postId={post.id}
              audioUrl={post.spotifyUrl || post.youtubeUrl || ''}
        ...
        {post.additionalPhotos && post.additionalPhotos.length > 0 && (
          <div className="mb-6">
            <div className="grid grid-cols-2 gap-2">
              {post.additionalPhotos.map((photoUrl: string, index: number) => (
                <img
                  key={index}
                  src={photoUrl}
