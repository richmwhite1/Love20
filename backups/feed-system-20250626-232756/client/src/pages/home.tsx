...
export default function Home() {
  ...
  const handleStoryClick = (userId: string) => {
    // Navigate to user's profile or story view
    console.log('Story clicked for user:', userId);
  };

  const handleMarkStoryViewed = (userId: string) => {
    // Mark story as viewed
    console.log('Marking story as viewed for user:', userId);
  };
  ...
  return (
    <div className="bg-black">
      ...
      {isAuthenticated && (
        <Stories 
          users={Array.from(viewedStoryUsers).map(id => ({ id: id.toString(), name: '', username: '' }))}
